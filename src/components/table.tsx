        ...
        {infoChurras.length > 0 ? (
          <>
            ...
            <tr>
              ...
              <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Quantidade
                de Pessoas
              </th>
              <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Carne</th>
              <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Pão
                de Alho
              </th>
              ...
              <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Cerveja
              </th>
            ...
            {infoChurras.map((row) => (
              <tr key={row.id}>
                ...
                <td className="px-6 py-4 whitespace-nowrap">
                  <Link to={`/form/${row.id}`}
                        className="bg-blue-500 text-white py-1 px-3 rounded mr-2">Editar</Link>
                  <button onClick={() => onDelete(row.id || '')}
                          className="bg-red-500 text-white py-1 px-3 rounded">Excluir
                  </button>
                </td>
              </tr>
            ))}
          ...
          <tbody>
          <tr>
            <td colSpan={8} className="px-6 py-4 whitespace-nowrap text-center text-gray-500">Nenhum dado
              disponível
            </td>
          </tr>
          </tbody>
