        ...
        <fieldset className="border border-solid border-blue-900 p-3">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            <div>
              ...
              <Input type="text" register={register} name="homens" defaultValue={churrascoData?.homens || ''}
                     error={errors.homens} className="bg-gray-200 p-2 rounded"/>
            </div>
            <div>
              <label htmlFor="mulheres" className="block">Mulheres:</label>
              <Input type="text" register={register} name="mulheres" defaultValue={churrascoData?.mulheres || ''}
                     error={errors.mulheres} className="bg-gray-200 p-2 rounded"/>
            </div>
            <div>
              <label htmlFor="criancas" className="block">Crianças:</label>
              <Input type="text" register={register} name="criancas" defaultValue={churrascoData?.criancas || ''}
                     error={errors.criancas} className="bg-gray-200 p-2 rounded"/>
            </div>
